                            ...
                            <div class="card-body pt-0 pb-5">
                                <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                                    ...
                                    <tr>
                                        <th>ID</th>
                                        <th>Name</th>
                                        <th class="d-none d-md-table-cell">Category id</th>
                                    ...
                                    @foreach($subcategories as $subcategory)
                                        <tr>
                                            ...
                                            <td >
                                                <a class="text-dark" href="">{{ $subcategory->name }}</a>
                                            </td>
                                            <td class="d-none d-md-table-cell">{{ $subcategory->category_id }}</td>
                                            <td class="d-none d-md-table-cell">{{ substr($subcategory->description, 0, 60) . (strlen($subcategory->description) > 60 ? '...' : '') }}</td>
                                            <td class="text-right">
