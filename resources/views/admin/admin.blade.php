...
<head>
    ...
    <!-- PLUGINS CSS STYLE -->
    <link href="/plugins/toaster/toastr.css" rel="stylesheet" />
        ...
        <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="sidebar-scrollbar">
                ...
                <ul class="nav sidebar-inner" id="sidebar-menu">
                    ...
                    <li  class="" >
                        <a class="sidenav-item-link" href="{{ route('category.table') }}"
                    ...
                    <li  class="" >
                        <a class="sidenav-item-link" href="{{ route('subcategory.table') }}"
                           aria-expanded="false" aria-controls="ui-elements">
                            <i class="mdi mdi-folder-multiple-outline"></i>
                    ...
                    <li  class="" >
                        <a class="sidenav-item-link" href="{{ route('product.table') }}"
                           aria-expanded="false" aria-controls="ui-elements">
                            <i class="mdi mdi-folder-multiple-outline"></i>
